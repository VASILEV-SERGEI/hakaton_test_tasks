Проект с интерактивными графиками доступен по [ссылке](https://nbviewer.org/github/VASILEV-SERGEI/pet_projects/blob/main/pet_project_hockey/pet_project_hockey_fr.ipynb "Нажми для перехода")
